...
>(({className, ...props}, ref) => (
  <div className='absolute left-0 top-full flex justify-center'>
    <NavigationMenuPrimitive.Viewport
      ref={ref}
      className={cn(
        'origin-top-center rounded-b-md border bg-popover text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90',
        'h-(--radix-navigation-menu-viewport-height) w-full min-w-(--radix-navigation-menu-viewport-width) md:w-(--radix-navigation-menu-viewport-width)',
        className
      )}
      {...props}
    />
